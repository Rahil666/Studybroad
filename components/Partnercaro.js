                      ...
                      <div className="col-md-3 mb-3">
                        <div className="card slide">
                          ...
                          <div class="">
                            ...
                            <p class="">
                              Course 1: Diploma in Hospitality Operations Course
                              2: Diploma in Aviation And Travel Operations
                              Qualification: 10th/12th Pass Age limit: 45 Years
                            </p>
                          </div>
                        </div>
                      </div>
                      ...
                      <div className="col-md-3 mb-3">
                        <div className="card slide">
                          ...
                          <div class="">
                            ...
                            <p class="">
                              Course: Diploma in Hospitality And Advanced
                              Diploma in Hospitality Qualification: 10th/12th
                              Pass Age limit: 45 Years
                            </p>
                          </div>
                        </div>
                      </div>
                      <div className="col-md-3 mb-3">
                        <div className="card slide">
                          ...
                          <div class="">
                            ...
                            <p class="">
                              Course: Diploma in Hospitality Qualification:
                              10th/12th Pass Age limit: 45 Years
                            </p>
                          </div>
                        </div>
                      </div>
                      <div className="col-md-3 mb-3">
                        <div className="card slide">
                          ...
                          <div class="">
                            ...
                            <p class="">
                              Course 1: Diploma in Food Technology & Catering
                              (DFTC) Course 2: Advanced Diploma in Food
                              Technology & Operations (ADFTO) Course 3: Diploma
                              in Building Services Management (DBSM)
                              Qualification: 10th/12th Pass Age limit: 45 Years
                            </p>
                          </div>
                        </div>
